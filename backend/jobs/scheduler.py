...
from apscheduler.events import EVENT_JOB_EXECUTED, EVENT_JOB_ERROR, JobExecutionEvent, JobErrorEvent
from sqlalchemy.ext.asyncio import AsyncSession
from sqlalchemy import text, select

from backend.db.database import async_session_maker
from backend.models.ml_models import SchedulerLock, SchedulerConfig, SystemMetric, AuditLogExtended
...
async def init_scheduler():
    ...
    await scheduler.schedule_cache_refresh(30)
